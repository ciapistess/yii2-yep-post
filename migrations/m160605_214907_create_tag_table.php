...
class m160605_214907_create_tag_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk_post_tag_updated_by', self::TAG_TABLE, 'updated_by', '{{%user}}', 'id', $SETNULL_OR, $CASCADE_OR);
        ...
        $this->addForeignKey('fk_post_tag_tag_id', self::TAG_POST_TABLE, 'tag_id', self::TAG_TABLE, 'id', $CASCADE_OR, $CASCADE_OR);
